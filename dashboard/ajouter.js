...
var addButton = document.getElementById("bouton_ouvrir");

// Ajouter un écouteur d'événement au clic sur le bouton
addButton.addEventListener("click", function() {
    // Sélectionner le champ de saisie utilisateur
    var userInput = document.getElementById("input_ajouter-plaque");
    ...
    if (plaqueImmatriculation === "") {
        alert("Veuillez saisir une plaque d'immatriculation avant d'ajouter.");
    } else {
        ...
        fetch('https://da7249d4-6fb3-41cf-8186-29452ad842a0.mock.pstmn.io/Dashboard/GestionPlaque/ajouter_plaque', options)
            .then(response => {
                ...
                alert('Plaque d\'immatriculation ajoutée avec succès!');
            })
            .catch(error => {
                console.error('Erreur:', error);
                // En cas d'erreur, afficher un message d'erreur
                alert('Erreur lors de l\'ajout de la plaque d\'immatriculation. Veuillez réessayer plus tard.');
            });
    }
});
