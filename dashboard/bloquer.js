// Sélectionner le bouton "Bloquer"
var blockButton = document.getElementById("bouton_bloquer");

// Ajouter un écouteur d'événement au clic sur le bouton
blockButton.addEventListener("click", function() {
    
    // Sélectionner le champ de saisie utilisateur
    var userInput = document.getElementById("input_bloquer");
    ...
    if (plaqueImmatriculation === "") {
        alert("Veuillez saisir une plaque d'immatriculation avant de bloquer.");
    } else {
        ...
        fetch('https://da7249d4-6fb3-41cf-8186-29452ad842a0.mock.pstmn.io/Dashboard/GestionPlaque/bloquer_plaque', options)
            .then(response => {
                ...
                alert('Plaque d\'immatriculation bloquée avec succès!');
            })
            .catch(error => {
                console.error('Erreur:', error);
                // En cas d'erreur, afficher un message d'erreur
                alert('Erreur lors du blocage de la plaque d\'immatriculation. Veuillez réessayer plus tard.');
            });
    }
});